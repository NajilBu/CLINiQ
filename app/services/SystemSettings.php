...
function cliniq_mail_template_definitions(): array
{
    return [
        ...
        'appointment_confirmed' => [
            ...
            'description' => 'Sent when a patient appointment is confirmed.',
            ...
            'default' => [
                'subject' => '[{{clinic_name}}] Appointment confirmed',
                'heading' => 'Your appointment is confirmed, {{patient_name}}',
                'message' => 'Your appointment with {{clinic_name}} has been confirmed. Please log in to the patient portal to review the appointment details.',
                'button_label' => 'View Appointment',
                'footer' => 'Contact {{clinic_name}} if you need to update your appointment.',
            ],
        ],
        'appointment_reminder' => [
            'label' => 'Appointment Reminder',
            'description' => 'Sent before a scheduled patient appointment.',
            'icon' => 'event',
            'action_hint' => 'The button opens the patient appointment page.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] Appointment reminder',
                'heading' => 'Appointment reminder for {{patient_name}}',
                'message' => 'This is a reminder that you have an upcoming clinic appointment. Please log in to review the date, time, and preparation instructions.',
                'button_label' => 'View Appointment',
                'footer' => 'Please contact {{clinic_name}} as soon as possible if you cannot attend.',
            ],
        ],
        'appointment_changes' => [
        ...
        'ape_document_correction' => [
            ...
            'description' => 'Sent when an online APE document needs correction.',
            'icon' => 'edit_document',
            'action_hint' => 'The button opens the APE status page.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] APE document correction required',
                'heading' => 'An APE document needs correction, {{patient_name}}',
                'message' => 'One or more documents submitted for your APE need correction. Please log in to the patient portal, review the clinic instructions, and submit the corrected document.',
                'button_label' => 'Review APE Documents',
                'footer' => 'Contact {{clinic_name}} if you need help correcting your document.',
            ],
        ],
        'ape_hard_copy_correction' => [
            'label' => 'APE Hard-copy Correction',
            'description' => 'Sent when an APE hard-copy requirement needs correction or replacement.',
            'icon' => 'assignment_return',
            'action_hint' => 'The button opens the APE status page.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] APE hard-copy correction required',
                'heading' => 'An APE requirement needs correction, {{patient_name}}',
                'message' => 'A hard-copy requirement for your APE needs correction or replacement. Please log in to review the clinic instructions and complete the required action.',
                'button_label' => 'Review APE Requirements',
                'footer' => 'Contact {{clinic_name}} if you need help with the required document.',
            ],
        ],
        'ape_clearance_correction' => [
            'label' => 'APE Clearance Correction',
            'description' => 'Sent when an APE clearance submission needs correction.',
            'icon' => 'health_and_safety',
            'action_hint' => 'The button opens the APE status page.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] APE clearance correction required',
                'heading' => 'Your APE clearance needs attention, {{patient_name}}',
                'message' => 'Your APE clearance submission needs correction. Please log in to the patient portal, review the instructions, and submit the required update.',
                'button_label' => 'Review APE Clearance',
                'footer' => 'Contact {{clinic_name}} if you need assistance.',
            ],
        ],
        'ape_follow_up_required' => [
            'label' => 'APE Follow-up Required',
            'description' => 'Sent when the clinic requires a patient follow-up action after an APE.',
            'icon' => 'medical_services',
            'action_hint' => 'The button opens the APE status page.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] APE follow-up required',
                'heading' => 'Your APE follow-up is ready, {{patient_name}}',
                'message' => 'The clinic has recorded a follow-up action for your APE. Please log in to review what you need to complete and any due date provided.',
                'button_label' => 'Review Follow-up',
                'footer' => 'Contact {{clinic_name}} if you need clarification about your follow-up plan.',
            ],
        ],
        'ape_follow_up_reminder' => [
            'label' => 'APE Follow-up Reminder',
            'description' => 'Sent before an APE follow-up action is due.',
            'icon' => 'notifications_active',
            'action_hint' => 'The button opens the APE status page.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] APE follow-up reminder',
                'heading' => 'Your APE follow-up is due soon, {{patient_name}}',
                'message' => 'This is a reminder that your APE follow-up action is due soon. Please log in to complete the required step or contact the clinic if you need assistance.',
                'button_label' => 'Complete Follow-up',
                'footer' => 'Contact {{clinic_name}} if you need help before the due date.',
            ],
        ],
        'ape_follow_up_overdue' => [
            'label' => 'APE Follow-up Overdue',
            'description' => 'Sent once when an APE follow-up action passes its due date.',
            'icon' => 'warning',
            'action_hint' => 'The button opens the APE status page.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] APE follow-up is overdue',
                'heading' => 'Your APE follow-up is overdue, {{patient_name}}',
                'message' => 'Our records show that your APE follow-up action is overdue. Please complete the required step or contact the clinic as soon as possible.',
                'button_label' => 'Review Follow-up',
                'footer' => 'Contact {{clinic_name}} if you need help resolving this overdue action.',
            ],
        ],
        'ape_documents_overdue' => [
            'label' => 'APE Documents Overdue',
            'description' => 'Sent once when required APE documents pass their due date.',
            'icon' => 'folder_off',
            'action_hint' => 'The button opens the APE status page.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] APE documents are overdue',
                'heading' => 'Your APE documents are overdue, {{patient_name}}',
                'message' => 'Our records show that required APE documents are still incomplete. Please upload the outstanding documents or contact the clinic if you need assistance.',
                'button_label' => 'Complete APE Documents',
                'footer' => 'Contact {{clinic_name}} if you need help completing your documents.',
            ],
        ],
        'ape_exam_missed' => [
            'label' => 'Missed APE Examination',
            'description' => 'Sent when a student does not complete an assigned APE examination.',
            'icon' => 'event_busy',
            'action_hint' => 'The button opens the APE status page.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] Missed APE examination — action needed',
                'heading' => 'Your scheduled APE examination was missed, {{patient_name}}',
                'message' => 'Our records show that you were unable to complete your scheduled APE examination. Please log in to review the next step or contact the clinic to arrange assistance.',
                'button_label' => 'Review APE Status',
                'footer' => 'Contact {{clinic_name}} to arrange the next step.',
            ],
        ],
        'patient_access_restricted' => [
            'label' => 'Patient Access Restricted',
            'description' => 'Sent when patient portal access becomes restricted.',
            'icon' => 'lock',
            'action_hint' => 'The button opens the patient portal dashboard.',
            'allowed_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'required_placeholders' => ['{{patient_name}}', '{{clinic_name}}'],
            'default' => [
                'subject' => '[{{clinic_name}}] Your patient portal access changed',
                'heading' => 'Your portal access changed, {{patient_name}}',
                'message' => 'Your patient portal access is currently restricted while your clinic account is under review. Please contact the clinic if you need assistance.',
                'button_label' => 'Open Patient Portal',
                'footer' => 'Contact {{clinic_name}} for more information about your account status.',
            ],
        ],
