...
function audit_log_action_label(string $action): string
{
    $labels = [
        ...
        'email_blocked' => 'Blocked a patient email',
        'email_blocked_retry_requested' => 'Retried a previously blocked patient email',
        ...
        'email_follow_up_resolved' => 'Resolved a patient email follow-up',
        'email_marked_for_follow_up' => 'Marked a patient email for follow-up',
        'email_queue_paused' => 'Paused automatic patient email processing',
        'email_manual_send_failed' => 'Manual patient email failed',
        'email_queued' => 'Queued a patient email',
        'email_queue_processed' => 'Processed the patient email queue',
        'email_queue_resumed' => 'Resumed automatic patient email processing',
        'email_retry_requested' => 'Retried a patient email',
        'email_resent' => 'Resent a patient email',
        'email_processed_now' => 'Processed a patient email immediately',
        'email_recipient_repaired' => 'Repaired a patient email recipient',
        ...
        'patient_registration_email_verified' => 'Verified an email for patient registration',
        'patient_registration_verification_requested' => 'Requested a patient-registration verification code',
        'patient_self_registered' => 'Created a student Applicant account',
