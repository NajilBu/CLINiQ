...
$instructions = pp_split_lines($patient['emergency_instructions'] ?? null, [
    ...
    'Contact the emergency person if the patient needs transfer or observation.',
]);
          ...
          <form class="pp-incident-drawer" id="incidentDrawer" role="region" aria-label="Incident response form" method="POST" action="" enctype="multipart/form-data">
            <div class="pp-form">
              ...
              <div>
                ...
                <input class="pp-textarea" id="incidentLocation" name="location" type="text" placeholder="Where is the patient now?" required style="min-height:2.75rem;resize:none;">
              </div>
              ...
              <div>
                <label class="pp-form-label" for="observedCondition">Patient Condition</label>
              ...
              <div class="pp-form-full">
                ...
                <textarea class="pp-textarea" id="incidentDesc" name="incident_notes" required placeholder="Describe what happened, the patient condition, actions already taken, and other observations."></textarea>
              </div>
