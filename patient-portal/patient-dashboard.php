...
<div class="student-grid student-dashboard-detail-stack">
    ...
    <section class="student-card student-card-pad student-clickable-card student-dashboard-reference" data-href="patient-passport.php" role="link" tabindex="0" aria-label="Open Health Passport profile">
    ...
    <section class="student-card student-span-4 student-clickable-card student-dashboard-duplicate student-dashboard-actionable student-dashboard-appointment-card <?= in_array($appointmentStatus, ['Cancelled', 'No Show'], true) ? 'student-dashboard-actionable-danger' : '' ?>" data-href="patient-appointment.php" role="link" tabindex="0" aria-label="Open appointment page">
        <div class="student-card-header">
            <div>
        ...
        <div class="student-card-pad">
            ...
            <?php endif; ?>
            <a href="patient-appointment.php" class="<?= in_array($appointmentStatus, ['Cancelled', 'No Show'], true) ? 'student-button-danger' : 'student-button-secondary' ?> w-full text-decoration-none">
                <?= student_e($appointmentCtaLabel) ?>
                <span class="material-symbols-outlined"><?= student_e($appointmentCtaIcon) ?></span>
            </a>
        </div>
    </section>
