    ...
    <?php else: ?>
        ...
        <form method="post" id="feedback-survey">
            ...
            <nav class="feedback-survey-progress clinic-card" aria-label="Feedback form progress">
                <span class="is-current" data-feedback-progress="1">1<span>Consent</span></span>
            ...
            <section class="clinic-card feedback-section">
                <h2>Data privacy notice and consent</h2>
                <p><strong>RA 10173 — Data Privacy Act of 2012.</strong> Your feedback is collected to evaluate and improve clinic services. Participation is voluntary and does not affect your access to care.</p>
                <details class="feedback-privacy">
                    <summary>Read the privacy notice and your rights</summary>
                    <div>
                        <p>Your visit details, ratings, comments, and consent record will be linked to this clinic visit for service quality improvement, accountability, and required clinic reporting. Your response is confidential but not anonymous.</p>
                        <p>Access is limited to authorized clinic personnel who need it for evaluation, support, or reporting. Reasonable safeguards are applied, and records are retained only as long as needed for these purposes and applicable requirements.</p>
                ...
                <label class="feedback-consent"><input type="checkbox" name="consent" value="1" required <?= feedback_value($values, 'consent') === '1' ? 'checked' : '' ?>><span>I have read the RA 10173 notice and voluntarily agree to the collection and use of my feedback for the purposes described above.</span></label>
            </section>
            <div class="feedback-actions feedback-wizard-actions"><button class="btn btn-primary" type="button" data-feedback-next>Continue to ratings <span class="material-symbols-outlined" aria-hidden="true">arrow_forward</span></button></div>
            </div>
            <div class="feedback-survey-step" data-feedback-step="2" hidden>
            <section class="clinic-card feedback-section"><h2 id="feedback-rating-title">Section 1: Service Evaluation (SERVPERF)</h2><p id="feedback-rating-help">Based on your actual experience during the visit shown above, rate each statement from <strong>1 (Strongly Disagree)</strong> to <strong>7 (Strongly Agree)</strong>. All 22 statements are required.</p></section>
            ...
            <section class="clinic-card feedback-section"><h2>Section 2: Open Feedback</h2>
