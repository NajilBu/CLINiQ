                    ...
                    <section aria-labelledby="passport-holder-heading" class="public-passport">
                        <div class="passport-preview-modern">
                            ...
                            <div class="passport-modern-content">
                                <section class="passport-modern-section"><div class="passport-modern-section-title"><span class="material-symbols-outlined">person</span> Personal information</div><div class="passport-modern-personal-grid"><div class="passport-modern-personal-item passport-modern-personal-item-wide"><span>Full name</span><strong><?= e($passportHolderName ?: 'Patient') ?></strong></div><div class="passport-modern-personal-item"><span>ID number</span><strong><?= e($patient['id_number'] ?: 'Not recorded') ?></strong></div><div class="passport-modern-personal-item"><span>Date of birth</span><strong><?= e(!empty($patient['birthdate']) ? date('M j, Y', strtotime((string) $patient['birthdate'])) : 'Not recorded') ?></strong></div><div class="passport-modern-personal-item"><span>Sex</span><strong><?= e($patient['sex'] ?: 'Not recorded') ?></strong></div><div class="passport-modern-personal-item"><span>Blood type</span><strong><?= e($patient['blood_type'] ?: '—') ?></strong></div></div></section>
                                <section class="passport-modern-section"><div class="passport-modern-section-title"><span class="material-symbols-outlined">medical_information</span> Medical information</div><div class="passport-modern-medical-list"><div class="passport-modern-medical-item"><span>Allergies</span><strong><?= e($patient['allergies'] ?: 'None reported.') ?></strong></div><div class="passport-modern-medical-item"><span>Medical conditions</span><strong><?= nl2br(e($patient['existing_conditions'] ?: 'None reported.')) ?></strong></div><div class="passport-modern-medical-item"><span>Current medications</span><strong><?= nl2br(e($patient['medications'] ?: 'No current medications recorded.')) ?></strong></div><div class="passport-modern-medical-item"><span>Emergency instructions</span><strong class="passport-modern-instructions"><?= nl2br(e($patient['emergency_instructions'] ?: 'Notify the clinic immediately.')) ?></strong></div></div></section>
