...
(4, 3, CURDATE(), 'APE Form', 'Checked', 'Follow-up Required', '/uploads/ape/26-01058-ape-bundle.pdf', 'Verified', 1, NULL, NULL, 'For Follow-up', 'History of asthma noted during APE review. Needs pulmonary clearance after school clinic observation.', 'Submit pulmonary clearance or treatment note after follow-up consultation.', 1, 'Pulmonary clearance required.', 'With Finding', 'Follow-up requirement tracked by clinic.', NULL, DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 5 DAY)),
(5, 5, CURDATE(), 'APE Form', 'Checked', 'Follow-up Required', '/uploads/ape/26-01089-ape-bundle.pdf', 'Verified', 1, NULL, NULL, 'Submitted', 'Food allergy history documented. Student submitted allergist clearance for review.', 'Clearance submitted; wait for clinic approval.', 1, 'Allergy clearance waiting for approval.', 'With Finding', 'Follow-up requirement tracked by clinic.', NULL, DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)),
(6, 8, CURDATE(), 'APE Form', 'Checked', 'Cleared', '/uploads/ape/26-01136-ape-bundle.pdf', 'Verified', 1, NULL, NULL, 'Cleared', 'No significant findings. Fit to study.', 'APE completed and archived.', 0, NULL, 'Fit to Proceed', 'Cleared for academic activities.', NULL, DATE_SUB(NOW(), INTERVAL 1 DAY), NOW()),
(7, 11, CURDATE(), 'APE Form', 'Checked', 'Cleared', '/uploads/ape/23-00211-ape-bundle.pdf', 'Verified', 2, NULL, NULL, 'Cleared', 'No significant findings. Fit to study.', 'APE requirements completed and cleared.', 0, NULL, 'Fit to Proceed', 'Cleared for academic activities.', NULL, DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)),
