...
$students = [
    [
        ...
        'ape' => ['Checked', 'Cleared', 'Cleared', 'No significant findings. Fit to study.'],
    ...
    [
        ...
        'ape' => ['Checked', 'Follow-up Required', 'For Follow-up', 'Allergic rhinitis history noted. Needs symptom monitoring.'],
